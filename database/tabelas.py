...
def inserir_herois(data):
    conectar.inserir("INSERT INTO herois (id, name, order_id, name_loc, str_base, str_gain, agi_base, agi_gain, int_base, int_gain, primary_attr, complexity, attack_capability, damage_min, damage_max, attack_rate, attack_range, projectile_speed, armor, magic_resistance, movement_speed, turn_rate, sight_range_day, sight_range_night, max_health, health_regen, max_mana, mana_regen, link_heroes_p, link_heroes_p1, link_heroes_p2) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)", data)

def inserir_herois_descricao(data):
    conectar.inserir("INSERT INTO herois_descricao (id, name, localized_name, primary_attr, attack_type, legs) VALUES (%s, %s, %s, %s, %s, %s)", data)

def inserir_herois_estilo(data):
    conectar.inserir("INSERT INTO herois_estilo (id, name) VALUES (%s, %s)", data)

def inserir_talentos(data):
    conectar.inserir("INSERT INTO talentos () VALUES ()", data)

def inserir_habilidades(data):
    conectar.inserir("INSERT INTO habilidades () VALUES ()", data)

def inserir_items(data):
    conectar.inserir("INSERT INTO items () VALUES ()", data)
